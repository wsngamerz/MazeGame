    ...
    public class TestScreen
    {
        ...
        private void DisplayBackgroundColours()
        {
            ...
            for (var i = 0; i < fields.Length; i++)
            {
                ...
                var backgroundPixel = new Pixel()
                {
                    Character = " ",
                    BackgroundColor = fieldInfo.GetValue(fieldInfo).ToString(),
        ...
        private void DisplayForegroundColours()
        {
            ...
            for (var i = 0; i < fields.Length; i++)
            {
                ...
                var foregroundPixel = new Pixel()
                {
                    Character = "x",
                    BackgroundColor = Style.BackgroundColor.Black,
                    ForegroundColor = fieldInfo.GetValue(fieldInfo).ToString()
                };
